              ...
              return (
                ...
                >
                  ...
                  <div className="pt-5 mt-4 border-t border-slate-100 dark:border-slate-800/80">
                    <a
                      href={`https://wa.me/6285880427199?text=${waText}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full inline-flex items-center justify-center gap-2 bg-slate-100 hover:bg-amber-500 text-slate-800 hover:text-slate-950 dark:bg-slate-800/80 dark:hover:bg-amber-500 dark:text-slate-200 dark:hover:text-slate-950 font-bold py-2.5 px-3 rounded-xl text-xs transition duration-150"
                    >
